...
function hocwp_theme_register_lib_superfish() {
	if ( ! function_exists( 'hocwp_option_optimize' ) && function_exists( 'Pixelify' ) ) {
		Pixelify()->load_plugin_theme_file( '/font-demo/hocwp/theme/inc/options.php', '/inc/options/setting-optimize.php' );
	}

	if ( ! function_exists( 'hocwp_option_optimize' ) ) {
		require_once( get_template_directory() . '/inc/options/setting-optimize.php' );
	}
...
function hocwp_theme_register_lib_perfect_scrollbar() {
	wp_enqueue_style( 'perfect-scrollbar-style', get_template_directory_uri() . '/lib/perfect-scrollbar/css/perfect-scrollbar.min.css' );
	wp_enqueue_script( 'perfect-scrollbar', get_template_directory_uri() . '/lib/perfect-scrollbar/js/perfect-scrollbar.jquery.min.js', array( 'jquery' ), false, true );
}
...
function hocwp_theme_get_reading_options( $key ) {
	...
	if ( empty( $hocwp_reading_options ) && function_exists( 'hocwp_option_reading' ) ) {
