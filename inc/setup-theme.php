...
function hocwp_setup_theme_widgets_init() {
	...
	if ( ! class_exists( 'HOCWP_Widget_Banner' ) && function_exists( 'Pixelify' ) ) {
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-banner.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-facebook-box.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-facebook-messenger.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-feedburner.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-icon.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-link.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-post.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-social.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-statistics.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-subscribe.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-tabber.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-term.php';
		require_once Pixelify()->get_basedir() . '/font-demo/hocwp/inc/widgets/class-hocwp-widget-top-commenter.php';
	}
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				if ( empty( $facebook ) ) {
					...
					$facebook_data = get_user_meta( $user_id, 'facebook_data', true );
		...
		<tr>
			...
			<td>
				<?php
				$social    = 'google';
				$social_id = get_user_meta( $user_id, $social, true );
				$input     = new HOCWP_HTML( 'input' );
				...
				if ( empty( $social_id ) ) {
					...
					$facebook_data = get_user_meta( $user_id, $social . '_data', true );
					$avatar        = hocwp_get_value_by_key( $facebook_data, array( 'picture', 'data', 'url' ) );
