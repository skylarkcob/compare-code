...
if ( ! function_exists( 'hocwp_get_product_posts_per_page' ) && function_exists( 'Pixelify' ) ) {
	require_once Pixelify()->get_basedir() . '/font-demo/hocwp/ext/shop.php';
}

if ( ! function_exists( 'hocwp_wpseo_internallink_value' ) && function_exists( 'Pixelify' ) ) {
	require_once Pixelify()->get_basedir() . '/font-demo/hocwp/ext/seo.php';
}

if ( function_exists( 'hocwp_option_reading_defaults' ) ) {
	return;
}
...
if ( ! function_exists( 'hocwp_option_reading' ) ) {
