...
if ( ! function_exists( 'hocwp_maintenance_mode_default_settings' ) && function_exists( 'Pixelify' ) ) {
	require_once Pixelify()->get_basedir() . '/font-demo/hocwp/theme/inc/options.php';
}
