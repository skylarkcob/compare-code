...
function hocwp_setup_theme_html_attr( $atts, $slug, $context ) {
	if ( 'html' == $slug ) {
		$lang = get_language_attributes();
		hocwp_add_attribute( $atts, '', $lang );
		hocwp_add_attribute( $atts, 'class', 'no-js' );
	}

	return $atts;
}

add_filter( 'hocwp_get_attr', 'hocwp_setup_theme_html_attr', 10, 3 );