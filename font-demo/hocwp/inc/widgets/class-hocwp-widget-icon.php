...
class HOCWP_Widget_Icon extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $icon_html ) ) {
			$icon_html = '<a href="' . $link . '" class="icon-link icon-url">' . $icon_html . '</a>';
			$icon_html = apply_filters( 'hocwp_widget_icon_icon_link_html', $icon_html, $args, $instance, $this );
			$widget_html .= $icon_html;
		}
		if ( (bool) $title_link ) {
	...
	public function form( $instance ) {
		...
		$args = array(
			'id'    => $this->get_field_id( 'icon_html' ),
			'name'  => $this->get_field_name( 'icon_html' ),
			'value' => $icon_html,
