...
if ( ! function_exists( 'hocwp_option_reading' ) ) {
	function hocwp_option_reading() {
		if ( ! function_exists( 'hocwp_option_reading_defaults' ) && function_exists( 'Pixelify' ) ) {
			Pixelify()->load_plugin_theme_file( '/font-demo/hocwp/theme/inc/options.php', '/inc/options/setting-reading.php' );
		}

		if ( ! function_exists( 'hocwp_option_reading_defaults' ) ) {
			require_once( get_template_directory() . '/inc/options/setting-reading.php' );
		}
