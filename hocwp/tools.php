...
if ( ! function_exists( 'hocwp_newsletter_time_range' ) ) {
...
if ( ! function_exists( 'hocwp_prevent_author_see_another_post' ) ) {
...
if ( ! function_exists( 'hocwp_delete_old_file' ) ) {
...
if ( ! function_exists( 'hocwp_is_table_exists' ) ) {
...
if ( ! function_exists( 'hocwp_get_url_params' ) ) {
